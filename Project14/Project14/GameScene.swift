...
//  Project14
//
//  Created by Guillermo Suarez on 3/4/24.
//
...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        let backgrond = SKSpriteNode(imageNamed: "whackBackground")
        backgrond.position = CGPoint(x: 512, y: 384)
        backgrond.blendMode = .replace
        backgrond.zPosition = -1
        addChild(backgrond)
